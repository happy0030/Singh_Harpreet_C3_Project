...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        Mockito.when(restaurantMock.getCurrentTime()).thenReturn(LocalTime.parse("13:30:00"));
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant restaurantMock = Mockito.spy(restaurant);
        Mockito.when(restaurantMock.getCurrentTime()).thenReturn(LocalTime.parse("08:00:00"));
        assertFalse(restaurantMock.isRestaurantOpen());
        Mockito.when(restaurantMock.getCurrentTime()).thenReturn(LocalTime.parse("23:00:00"));
        assertFalse(restaurantMock.isRestaurantOpen());
